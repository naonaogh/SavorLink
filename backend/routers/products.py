...
from backend.database.schemas.category import CategoryRead
from backend.services.product_service import ProductService
from backend.routers.deps import get_current_user
from backend.database.models import User, UserRole, Category
...
async def create_product(
    ...
    # Берем первое предприятие пользователя (для MVP)
